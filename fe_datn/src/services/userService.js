...
const adminGetAllShops = (idInput, access_token) => {
  return axios.get(`/api/admin-get-all-shops`, {
    params: { id: idInput, access_token: access_token },
  });
};
const adminGetAllShippers = (idInput, access_token) => {
  return axios.get(`/api/admin-get-all-shippers`, {
    params: { id: idInput, access_token: access_token },
  });
};
const adminGetAllBuyers = (idInput, access_token) => {
  return axios.get(`/api/admin-get-all-buyers`, {
    params: { id: idInput, access_token: access_token },
  });
};
...
const deleteUserService = (userId, access_token) => {
  let data = {
    id: userId,
...
const changeStatusUser = (data) => {
  return axios.post("/api/change-status-user", data);
};
