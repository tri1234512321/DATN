...
class AllFoodShop extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isOpen: false,
  ...
  async componentDidMount() {
    await this.props.getAllProductByBuyer(this.props.idShop);
  }
  ...
  render() {
    ...
    <div className="flex justify-center">
      <div className="w-[1200px] bg-white px-[15px] py-[20px]">
        <div
...
const mapDispatchToProps = (dispatch) => ({
  getAllProductByBuyer: (id) =>
    dispatch(actions.fetchAllItemProductByBuyerStart(id)),
  addFoodToCart: (data) => dispatch(actions.fetchAddFoodToCartStart(data)),
  navigate: (path) => dispatch(push(path)),
});

export default connect(mapStateToProps, mapDispatchToProps)(AllFoodShop);
