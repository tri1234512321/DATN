...
const FindUsers = () => {
  ...
  const { isLoading, error, data } = useQuery(["findUsers", findedUsers], () =>
    makeRequest.get("/findUsers",{params:{name:findedUsers,access_token:currentUser.access_token}}).then((res) => {
  ...
  return (
    ...
    <div className="pt-[10px]">
      <p className="font-bold mb-[15px]">Tìm kiếm người dùng</p>
